      ...
      >
        ...
        <div className="absolute top-4 right-4 z-10 flex items-center gap-2">
          <button
            ...
            className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center transition-colors shadow-lg active:scale-95"
